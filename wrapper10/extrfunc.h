 ...
 * has been loaded. It's purpose is to allocate and initialize the
 ...
 * is unloaded. It's purpose is to free the library-specific data.
 */
 ...
 * 
 * It's purpose is to check whether the API version of the library
