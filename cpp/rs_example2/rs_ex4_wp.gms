...
pos_xf     "intial position in x direction"                   /1700361/ 
pos_yf     "intial position in y direction"                   /229300/
pos_zf     "intial position in z direction"                   /-1260/
...
file wdata2 /current_ex3_fx.csv/;
*wdata2.ap = 1; {Flag to turn the append option on for the file with pointer wdata.}
