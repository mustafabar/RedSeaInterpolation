...
VmaxC                                                         /3/
dt                                                             /500/
pos_x0     "intial position in x direction"                   /696814/ 
pos_y0     "intial position in y direction"                   /1735314/
pos_z0     "intial position in z direction"                   /-80/
pos_xf     "intial position in x direction"                   /639176/ 
pos_yf     "intial position in y direction"                   /1710196/
pos_zf     "intial position in z direction"                   /-1740/
...
if(Par(se,'ft') < BIGTF,
   ...
   until card(hd) = 0   or timeelapsed > 7000;
