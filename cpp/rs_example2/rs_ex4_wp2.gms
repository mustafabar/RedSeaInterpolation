...
VmaxC                                                         /3/
dt                                                             /610/
pos_x0     "intial position in x direction"                   /1688658/ 
pos_y0     "intial position in y direction"                   /162436/
pos_z0     "intial position in z direction"                   /-1900/
pos_xf     "intial position in x direction"                   /1700000/ 
pos_yf     "intial position in y direction"                   /258958/
pos_zf     "intial position in z direction"                   /-1800/
...
if(Par(se,'ft') < BIGTF0,
   ...
   until card(hd) = 0   or timeelapsed > 200;
...
file wdata2 /current_ex4_wp2.csv/;
*wdata2.ap = 1; {Flag to turn the append option on for the file with pointer wdata.}
...
if(Par(se,'ft') < BIGTF,
   ...
   until card(hd) = 0   or timeelapsed > 500;
