...
pos_z0     "intial position in z direction"                   /-2/
pos_xf     "intial position in x direction"                   /686563/ 
pos_yf     "intial position in y direction"                   /1711830/
pos_zf     "intial position in z direction"                   /-130/
...
file wdata2 /current_ex2_b_1.csv/;
*wdata2.ap = 1; {Flag to turn the append option on for the file with pointer wdata.}
